    ...
    <DefaultLayout>
        <div className='container'>
            <div className='bg-success rounded bg-opacity-10 p-2 mt-2'>
                ...
                <p className='text-dl pt-0 text-center'>
                    Khi các bạn đọc đến những dòng này thì mình tin là các bạn đã có những mục tiêu
                    cho bản thân, và có những kế hoạch cụ thể cho việc học tiếng Hàn rồi phải không ạ.<br />
                    Còn với mình cũng sẽ cố gắng thật nhiều để mang đến cho các bạn những kiến thức bài giảng với hết khả năng của mình.<br /> 
                    Và cốt lõi nhất là kiến thức nên mình cố gắng xây dựng giao diện đơn gian nhất có thể (thật ra là một phần do còn gà về lập trình kaka).<br />
                    Trình bày sao cho các bạn dễ đọc, dễ hiểu nhất, và đặc biệt là nó hoàn toàn miễn phí. 
                    Và với tất cả những điều đó rất mong là các bạn chăm học để đạt kết quả như mong muốn.<br />
                    Sẽ chẳng thể một lần mà hoàn thiện được ngay nên trong quá trình học có chỗ nào lỗi cả về giao diện cả về nội dung thì các bạn hãy phản hồi về cho mình nhé.<br />
