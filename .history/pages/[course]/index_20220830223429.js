            ...
            <div className='bg-success rounded bg-opacity-10 p-2 mt-2'>
                ...
                <div className='col-9 m-auto'>
                    <p className='text-dl pt-0'>
                        ...
                        đầy đủ kiến thức, cũng như thông tin về chương trình này. Bạn có thể tìm hiểu kỹ hơn trong <Link href="/Blog/Qua-trinh-hoc-va-on-eps"><a>bài viết này</a></Link> ạ.
