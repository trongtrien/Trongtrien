...
import { LessonData } from '../../components/home/QuizData'
...
export async function getServerSideProps({params}) {
    const quizGrammarData = quizGrammar_data().data
    try {
     const id = params.id.slice(4)
     return {props: {
        id: id,
        data:quizGrammarData.find(d => d.id == id)||null
    }}
    } catch (error) {
