          ...
          <div className="bg-secondary rounded-3 p-3 mb-4">
            <div>
              <input
                ...
                style={{borderTopRightRadius: "0", borderBottomRightRadius: "0",border: "10px solid #123 !important"}}
                onKeyDown={(e) => {
              ...
              />
              <button className="btn btn-primary" style={{borderTopLeftRadius: "0", borderBottomLeftRadius: "0", border: "1px solid #123 !important"}}  type="submit" onClick={()=>{
                search()
                if(newData){
                  setQuery('')
                }
