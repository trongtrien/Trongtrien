          ...
          <div className="bg-secondary rounded-3 p-3 mb-4">
            <div>
              <input
                ...
                className="input btn bg-dl text-dl style={{fontSize: "5rem", borderTopLeftRadius: "0", borderBottomLeftRadius: "0"}}"
                onKeyDown={(e) => {
              ...
              />
              <button className="btn btn-primary" style={{fontSize: "5rem", borderTopLeftRadius: "0", borderBottomLeftRadius: "0"}}  type="submit" onClick={()=>{
                search()
                if(newData){
                  setQuery('')
                }
