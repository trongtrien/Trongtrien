    ...
    <div className="container pb-4">
        <div className='pt-5'>
            <h2 className='pt-3 mb-4'>
              <button className="btn-main-y rounded-3 ps-4 pe-4 p-2">Khóa học ({listChapterDetail.lessonLabel})</button>
            </h2>
        ...
        <div className="row pb-3">
          ...
          <div className="col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-5" key={index}>
                            {item.id<10&&
                            <EpsCard data={item} />}
            </div>)}
        </div>
