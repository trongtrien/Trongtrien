    ...
    <div className="container pb-4">
        <div className='pt-5'>
            <h2 className='pt-3 mb-4'>
              <button className="btn btn-main-y fs-4 rounded-3 ps-4 pe-4 p-2">Khóa học ({listChapterDetail.lessonLabel})</button>
            </h2>
            ...
            <div>
                ...
                <button type="button" className="btn btn-main-y rounded-3 ps-4 pe-4 p-2 fs-5" onClick={() => {
                  pageviewCount(listChapterDetail.id)
                  setTimeout(() => Router.push(listChapterDetail.goLink), 200)
                }}>Vào học</button>
                <button type="button" className="btn btn-main-y rounded-3 ps-4 pe-4 p-2 fs-5 ms-2" onClick={() => {
            ...
            <div className='mt-3'>
                <button type="button" className="btn btn-main-y rounded-3 ps-4 pe-4 p-2 fs-5" onClick={Show}>{show?'Tắt hướng dẫn sử dụng khóa học':'Hướng dẫn sử dụng khóa học'}</button>
