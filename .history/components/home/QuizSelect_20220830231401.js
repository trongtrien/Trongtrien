                    ...
                    <div className="border border-warning rounded">
                      ...
                      <div className="form-footer d-flex pt-3 pb-3 border-top border-warning">
                            ...
                            <div className="modal-dialog modal-xl modal-dialog-centered">
                              <div className="modal-content">
                                <div className="modal-header d-flex">
                                  <h5 className="modal-title" id="exampleModalLabel">Ngữ pháp bài {questions[0][0].lesson_id}: 
                                    <span className="border border-warning p-2 ps-3 pe-3 ms-2 rounded">{questions[0][0].Grammar1}</span>
                                ...
                                <div className="modal-body">
                                  <div className='ratio ratio-16x9 p-0 border rounded'>
                                    {token&&decoded.role=="premium"?<iframe
                          ...
                          {!showScore&&<button type="button" className="btn btn-main-y rounded-pill ps-3 p-1 pe-3" 
                                  ...
                                  >Xem lại ngữ pháp bài {questions[currentQuestion][0].lesson_id}</button>}
                          {showScore?<button
