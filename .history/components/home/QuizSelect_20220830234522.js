                            ...
                            <div className="modal-dialog modal-xl modal-dialog-centered">
                              <div className="modal-content">
                                <div className="modal-header d-flex">
                                  <h5>{questions[0][0].lesson_id}과: 
                                  <span className="border border-warning p-2 ps-3 pe-3 ms-2 rounded">{questions[0][0].Grammar1}</span>
                                  <span className="border border-warning p-2 ps-3 pe-3 ms-2 rounded">{questions[0][0].Grammar2}</span></h5>
                                ...
                                <div className="modal-body">
                                    ...
                                    :"Chức năng chỉ dành cho các thành viên premium, vip2"}
