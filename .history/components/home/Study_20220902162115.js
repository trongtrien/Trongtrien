...
const Study = () => {
    ...
    const Data = [
        ...
        },
        {
            ...
            childElement: <QuizGrammar data={datas.filter((d) => d.id <= 15)}/>,
            link: "Grammar-Quiz/Unit06"
        },
        {
            title: "Hội thoại 60 bài - Conversation",
            childElement: <Conversation data={datas.filter((d) => d.id <= 15)}/>,
            link: "Conversation/Unit05"
        },
        {
            title: "EPS-TOPIK",
            childElement: <TestEPS data={datas.filter((d) => d.id <= 15)}/>,
