        ...
        {lesson?<>
          <div className='col-xl-9 p-0 m-0 border-1 border-end border-warning'>
                    ...
                    <ul className={`nav nav-tabs pt-2 ${!isMobile800&&'ps-5'}`} style={{fontSize: "15px"}}>
                        ...
                        {token&&<li className="nav-item item-action">
                            <button id='btn3' onClick={()=>setBtnId('3')}  className={`nav-link p-2 ${btnId==="3"&&"active"}`}>Ghi chú</button>
                        </li>}
                    ...
                    <div className='p-3 mt-1'>
                        ...
                        {btnId==="2"&&(token?(
                            ...
                            <Practice idParam={id} titleParam={titleParam} updateProgress={updateProgress} progress={progress} link={link}/>
                            ):(
                            <Practice idParam={id} titleParam={titleParam} updateProgress={updateProgress} progress={progress} link={link}/>)
                            )}
                        {(token&&btnId==="3")&&< Note 
