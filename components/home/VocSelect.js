                    ...
                    <div className="border border-warning rounded">
                      ...
                      <div className="form-footer d-flex pt-3 pb-3 border-top border-warning">
                          ...
                          {showScore?<div className='d-flex' style={{width: "100%"}}>
                            <button className='btn btn-main-y ps-3 p-1 pe-3 me-auto' onClick={handlePrevious}><i className="fa fa-angle-left fs-1" aria-hidden="true"></i></button>
                            <button
                              className="btn btn-main-y ps-3 p-1 pe-3 ms-auto"
                              role="button"
                              onClick={
                              currentQuestion + 1 == questions.length
                              ? handleSubmitButton
                              : handleNext
                            }>{(currentQuestion + 1 === questions.length&&disabledOptions) ? <i className="fa fa-check fs-1 text-success" aria-hidden="true"></i> : <i className="fa fa-angle-right fs-1" aria-hidden="true"></i>}</button>
                          </div>
                            :
