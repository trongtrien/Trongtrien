                      ...
                      <div className="form-footer d-flex pt-3 pb-3 border-top border-warning">
                          ...
                          {showScore?<div className='d-flex' style={{width: "100%"}}>
                            ...
                            <button
                              ...
                              ? handleSubmitButton
                              : handleNext
                            }>{currentQuestion + 1 === questions.length ? <i className="fa fa-check fs-1 text-success" aria-hidden="true"></i> : <i className="fa fa-angle-right fs-1 text-info" aria-hidden="true"></i>}</button>
                          </div>
                            :
